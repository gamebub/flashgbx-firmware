...
#ifndef _LK_GAMEBUB_H_
#define _LK_GAMEBUB_H_
...
#define LK_CART_MODE_SWITCH_SUPPORT			true
...
#define _delay_us(us)						{ for (u32 delay = 0; delay < us; delay++) { __NOP(); __NOP(); __NOP(); } } // 20.6µs at (20)
...
#define CART_MODE_SWITCH_GET()				GPIO_CART_SWITCH // 0 = AGB, 1 = DMG
